...
call python autotrigger.py --submit "True" --product "libralte" --icase_svn_rel "" --target_build_variant "eng" --testtype "libralte_marble_rfa_all_index" --icase_index "testcloud_self_run_index" --icase_mode "test_automation/system_tests/RFA" --icase_path "tools/test_automation" 
goto backrfaTrigger
